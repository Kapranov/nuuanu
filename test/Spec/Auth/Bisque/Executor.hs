...
module Spec.Auth.Bisque.Executor (specs) where

import Auth.Bisque.Datalog.AST                   ( Expression
                                                 , Fact
                                                 , Rule
                                                 , Term' (..)
                                                 )
import Auth.Bisque.Datalog.Executor              ( Limits (..)
                                                 , defaultLimits
                                                 , evaluateExpression
                                                 )
import Auth.Bisque.Datalog.Parser                ( expressionParser
                                                 , fact
                                                 , rule
                                                 )
import Auth.Bisque.Datalog.ScopedExecutor hiding (limits)
